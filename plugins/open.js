    ...
    switch (type) {
        case 'common':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let _cs = `${Math.floor(Math.random() * 20)}`.trim()
                    let _cc = `${Math.floor(Math.random() * 2)}`.trim()
                    let _cp = `${Math.floor(Math.random() * 1)}`.trim()
                    let _ce = `${Math.floor(Math.random() * 25)}`.trim()
...
`.trim()
                    ...
                    break
                case '10':
                    let _cs1 = `${Math.floor(Math.random() * 500)}`.trim()
                    let _cc1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _cp1 = `${Math.floor(Math.random() * 3)}`.trim()
                    let _ce1 = `${Math.floor(Math.random() * 550)}`.trim()
...
`.trim()
                    ...
                    break
                case '100':
                    let _cs2 = `${Math.floor(Math.random() * 3000)}`.trim()
                    let _cc2 = `${Math.floor(Math.random() * 25)}`.trim()
                    let _cp2 = `${Math.floor(Math.random() * 15)}`.trim()
                    let _ce2 = `${Math.floor(Math.random() * 1500)}`.trim()
...
`.trim()
                    ...
                    break
                case '1000':
                    let _cs3 = `${Math.floor(Math.random() * 7500)}`.trim()
                    let _cc3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _cp3 = `${Math.floor(Math.random() * 75)}`.trim()
                    let _ce3 = `${Math.floor(Math.random() * 5000)}`.trim()
                    let _cu3 = `${Math.floor(Math.random() * 75)}`.trim()
                    let cs3 = (_cs3 * 1)
                    let cc3 = (_cc3 * 1)
                    let cp3 = (_cp3 * 1)
                    let ce3 = (_ce3 * 1)
        ...
        case 'uncommon':
            switch (jumlah) {
                ...
                case 'crate':
                    ...
                    let _us = `${Math.floor(Math.random() * 150)}`.trim()
...
`.trim()
                ...
                case '10':
                    ...
                    let _us1 = `${Math.floor(Math.random() * 550)}`.trim()
                    let _up1 = `${Math.floor(Math.random() * 5)}`.trim()
                    let _umc1 = `${Math.floor(Math.random() * 2)}`.trim()
                    let _uu1 = `${Math.floor(Math.random() * 4)}`.trim()
                    let _uc1 = `${Math.floor(Math.random() * 5)}`.trim()
                    let ud1 = (_ud1 * 1)
                    let ue1 = (_ue1 * 1)
                    let us1 = (_us1 * 1)
                    let up1 = (_up1 * 1)
...
`.trim()
                    ...
                    break
                case '100':
                    let _ud2 = `${Math.floor(Math.random() * 15)}`.trim()
                    let _ue2 = `${Math.floor(Math.random() * 3000)}`.trim()
                    let _us2 = `${Math.floor(Math.random() * 7500)}`.trim()
                    let _up2 = `${Math.floor(Math.random() * 25)}`.trim()
                    let _umc2 = `${Math.floor(Math.random() * 7)}`.trim()
                    let _uu2 = `${Math.floor(Math.random() * 25)}`.trim()
                    let _uc2 = `${Math.floor(Math.random() * 30)}`.trim()
                    let ud2 = (_ud2 * 1)
                    let ue2 = (_ue2 * 1)
                    let us2 = (_us2 * 1)
                    let up2 = (_up2 * 1)
...
`.trim()
                    ...
                    break
                case '1000':
                    let _ud3 = `${Math.floor(Math.random() * 55)}`.trim()
                    let _ue3 = `${Math.floor(Math.random() * 6000)}`.trim()
                    let _us3 = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _up3 = `${Math.floor(Math.random() * 100)}`.trim()
                    let _umc3 = `${Math.floor(Math.random() * 75)}`.trim()
                    let _uu3 = `${Math.floor(Math.random() * 125)}`.trim()
                    let _uc3 = `${Math.floor(Math.random() * 175)}`.trim()
                    let ud3 = (_ud3 * 1)
                    let ue3 = (_ue3 * 1)
                    let us3 = (_us3 * 1)
                    let up3 = (_up3 * 1)
...
`.trim()
        ...
        case 'mythic':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let _ms = `${Math.floor(Math.random() * 500)}`.trim()
                    let _mmm = `${pickRandom(['0', '0', '1', '0'])}`.trim()
                    let _me = `${Math.floor(Math.random() * 550)}`.trim()
...
`.trim()
                    ...
                    break
                case '10':
                    let _ms1 = `${Math.floor(Math.random() * 10000)}`.trim()
...
`.trim()
                    ...
                    break
                case '100':
                    let _ms2 = `${Math.floor(Math.random() * 25000)}`.trim()
                    let _mmm2 = `${Math.floor(Math.random() * 10)}`.trim()
                    let _me2 = `${Math.floor(Math.random() * 25000)}`.trim()
...
`.trim()
                    ...
                    break
                case '1000':
                    let _ms3 = `${Math.floor(Math.random() * 100000)}`.trim()
...
`.trim()
        ...
        case 'legendary':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let _ls = `${Math.floor(Math.random() * 1000)}`.trim()
                    let _le = `${Math.floor(Math.random() * 750)}`.trim()
                    let _lp = `${Math.floor(Math.random() * 9)}`.trim()
...
`.trim()  
                    ...
                    break
                case '10':
                    let _ls1 = `${Math.floor(Math.random() * 10000)}`.trim()
                    let _le1 = `${Math.floor(Math.random() * 9900)}`.trim()
...
`.trim()  
                    ...
                    break
                case '100':
                    let _ls2 = `${Math.floor(Math.random() * 100000)}`.trim()
                    let _le2 = `${Math.floor(Math.random() * 75000)}`.trim()
...
`.trim()  
                    ...
                    break
                case '1000':
                    let _ls3 = `${Math.floor(Math.random() * 1000000)}`.trim()
                    let _le3 = `${Math.floor(Math.random() * 500000)}`.trim()
        ...
        case 'pet':
            ...
            if (global.db.data.users[m.sender].pet > 0) { 
                ...
                if (_pet == 'kucing' && kucing > 0) {
                    ...
                    global.db.data.users[m.sender].makananpet += mknp * 1
                    m.reply(pickRandom(['Anda kurang beruntung', 'Coba buka lagi lain kali, karena gak dapet pet', 'kasian gak dapet pet', 'Mungkin lagi gak hoki', 'wkwkkwkwke', 'yahaha gak hoki']) + '. Anda hanya mendapatkan *' + mknp + '* makanan pet')
                }
