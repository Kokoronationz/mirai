...
klik wa.me/${conn.user.jid.split`@`[0]}`, m.chat, {
      ...
      if (!room.pilih) this.send3Button(room.p, 'Silahkan pilih', `Menang +${room.poin}\nKalah -${room.poin_lose}`, 'Batu🗿', 'Batu', 'Kertas📄', 'Kertas', 'Gunting✂️', 'Gunting', m)
      if (!room.pilih2) this.send3Button(room.p2, 'Silahkan pilih', `Menang +${room.poin}\nKalah -${room.poin_lose}`, 'Batu🗿', 'Batu', 'Kertas📄', 'Kertas', 'Gunting✂️', 'Gunting', m)
